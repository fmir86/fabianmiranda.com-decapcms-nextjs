...
excerpt: "I took all 13 free Anthropic Academy courses. Here's what's actually worth your time: AI Fluency framework, Claude Code workflows, MCP server development, and agent skills. No paywall, certificates included. Full breakdown by learning track."
...
You can access the full catalog at [anthropic.com/learn](https://www.anthropic.com/learn).

---

*Fabian Miranda is an AI Solutions Architect and Full-Stack Developer based in Costa Rica. He works with US and global clients on AI implementation consulting, nearshore software development, and digital production. [Learn more](/about) or [get in touch](/contact).*
